 ...
 * </pre>
 *
 * @author Nick Folino and Connor Michetti
 *
 */
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    public final void add(K key, V value) {
        ...
        this.size++;
        int hashVal = mod(key.hashCode(), this.hashTable.length());
        this.hashTable.entry(hashVal).add(key, value);
    ...
    public final Pair<K, V> remove(K key) {
        ...
        this.size--;
        int hashVal = mod(key.hashCode(), this.hashTable.length());
        return this.hashTable.entry(hashVal).remove(key);
    ...
    public final Pair<K, V> removeAny() {
        ...
        return this.hashTable.entry(entry).removeAny();
    }
    ...
    public final V value(K key) {
        ...
        int hashVal = mod(key.hashCode(), this.hashTable.length());
        return this.hashTable.entry(hashVal).value(key);
    }
    ...
    public final boolean hasKey(K key) {
        ...
        int hashVal = mod(key.hashCode(), this.hashTable.length());
        return this.hashTable.entry(hashVal).hasKey(key);
    }
