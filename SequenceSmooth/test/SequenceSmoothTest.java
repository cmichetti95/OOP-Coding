...
public final class SequenceSmoothTest {
    ...
    /**
     * Test smooth with s1 = <0> and s2 = <1, 2, 3, 4>.
     */
    @Test
    public void test4() {
        /*
        ...
        Sequence<Integer> seq1 = this.createFromArgs(0);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(0);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 3, 4);
        Sequence<Integer> expectedSeq2 = this.createFromArgs();
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
    ...
    /**
     * Test smooth with s1 = <0, 1, 2, 3> and s2 = <1, 2, 3, 4>.
     */
    @Test
    public void test5() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(0, 1, 2, 3);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(0, 1, 2, 3);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 3, 4);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(0, 1, 2);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
    ...
    /**
     * Test smooth with s1 = <0, 1, 2, 3> and s2 = <>.
     */
    @Test
    public void test6() {
        /*
    ...
    /**
     * Test smooth with s1 = <-5, -10, -15, -20> and s2 = <>.
     */
    @Test
    public void test7() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(-5, -10, -15, -20);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-5, -10, -15, -20);
        Sequence<Integer> seq2 = this.createFromArgs();
        Sequence<Integer> expectedSeq2 = this.createFromArgs(-7, -12, -17);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
